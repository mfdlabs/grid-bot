...
public static class ServiceCollectionExtensions
{
    ...
    internal static IEnumerable<IConfigurationProvider> GetSettingsProviders()
    {
        ...
        var types = assembly?.GetTypes()
            .Where(t => string.Equals(t.Namespace, @namespace, StringComparison.Ordinal) &&
                        t.BaseType == typeof(BaseSettingsProvider))
            .ToList(); // finicky

        var singletons = new List<IConfigurationProvider>();

        if (types == null) return singletons;
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddSettingsProviders()
        {
        ...
        public IServiceCollection AddUtilities()
        {
            services.AddSingleton<IBacktraceUtility, BacktraceUtility>()
                ...
                .AddSingleton(RandomFactory.GetDefaultRandom())
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddGlobalLogger()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddJobManager()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddFloodCheckersRedis()
        {
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddClientSettings()
        {
            var serviceProvider = services.BuildServiceProvider();
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddDiscordEventHandlers()
        {
            // Event Handlers
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public IServiceCollection AddDiscord()
        {
