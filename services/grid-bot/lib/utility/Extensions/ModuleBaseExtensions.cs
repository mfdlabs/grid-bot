...
/// <summary>
/// Extension methods for <see cref="ModuleBase"/> and <see cref="ModuleBase{T}"/>
/// </summary>
public static class ModuleBaseExtensions
{
    ...
    ///     contains the sent message.
    /// </returns>
    public static Task<IUserMessage> ReplyWithReferenceAsync<T>(
        this ModuleBase<T> module, 
        string text = null, 
        bool isTTS = false, 
        Embed embed = null, 
        AllowedMentions allowedMentions = null, 
    ...
    ///     contains the sent message.
    /// </returns>
    public static Task<IUserMessage> ReplyWithFileAsync<T>(
        this ModuleBase<T> module, 
        Stream fileStream, 
        string fileName, 
        string text = null, 
    ...
    ///     contains the sent message.
    /// </returns>
    public static Task<IUserMessage> ReplyWithFilesAsync<T>(
        this ModuleBase<T> module, 
        IEnumerable<FileAttachment> attachments, 
        string text = null, 
        bool isTTS = false, 
