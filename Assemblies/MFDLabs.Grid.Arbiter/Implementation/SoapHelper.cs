...
namespace MFDLabs.Grid
{
    ...
    public sealed class SoapHelper : ComputeCloudServiceSoapClient
    {
        public static SoapHelper Singleton
        {
            get
            {
                ...
                return new SoapHelper(
                    _httpBinding,
                    new EndpointAddress("http://127.0.0.1:" + global::MFDLabs.Grid.Properties.Settings.Default.SoapHelperRemoteServicePort)
                );
            }
        }
        ...
        public SoapHelper(string endpointConfigurationName)
            : base(endpointConfigurationName)
        {
        }

        public SoapHelper(string endpointConfigurationName, string remoteAddress)
            : base(endpointConfigurationName, remoteAddress)
        {
        }

        public SoapHelper(string endpointConfigurationName, EndpointAddress remoteAddress)
            : base(endpointConfigurationName, remoteAddress)
        {
        }

        private SoapHelper(Binding binding, EndpointAddress remoteAddress)
