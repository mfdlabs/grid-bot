...
namespace MFDLabs.Concurrency.Base.Async
{
    ...
    public abstract class AsyncExpiringTaskThread<TSingleton, TItem> : AsyncBaseTaskThread<TSingleton, TItem>, IDisposable
        where TSingleton : AsyncExpiringTaskThread<TSingleton, TItem>, IDisposable, new()
        where TItem : class
    {
        ...
        {
            SystemLogger.Singleton.Debug("Starting expiring '{0}' with the delay of '{1}'", Name, ProcessActivationInterval);
