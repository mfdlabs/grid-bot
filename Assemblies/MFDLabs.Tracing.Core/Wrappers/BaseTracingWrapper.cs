...
namespace MFDLabs.Tracing.Core
{
    ...
    {
        public BaseTracingWrapper(ITracer tracer)
        {
            _Tracer = tracer;
        }
        ...
        public void StartSpan(string operationName, IDictionary<string, string> headersDictionary = null, bool allowNewSpan = false)
        {
            ...
            if (!(context == null && !allowNewSpan))
            {
                _Tracer.BuildSpan(operationName).AsChildOf(context).StartActive(false);
            }
        }
        ...
        private static Dictionary<string, object> ExtractErrorLog(Exception exception)
        {
            ...
            {
                errorLogs["stack"] = exception.StackTrace;
            }
            if (exception.Message != null)
            {
                errorLogs["message"] = exception.Message;
            }
            return errorLogs;
        }
        ...
        {
            return _Tracer.ActiveSpan != null;
        }
