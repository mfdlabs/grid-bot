...
namespace MFDLabs.Sentinels.CircuitBreakerPolicy
{
    ...
    {
        public DefaultCircuitBreakerPolicy(string circuitBreakerIdentifier, IDefaultCircuitBreakerPolicyConfig circuitBreakerPolicyConfig, ITripReasonAuthority<TExecutionContext> tripReasonAuthority) : base(tripReasonAuthority)
        {
