...
namespace MFDLabs.Users.Client
{
    ...
    {
        public UsersHttpClientBuilder(ICounterRegistry counterRegistry, UsersClientSettings httpClientSettings,
        ...
        private const string ClientCircuitBreakerPart = "MFDLabs.Users.Client.";
        private const string CategoryName = "MFDLabs.Users.Client";
    }
}
