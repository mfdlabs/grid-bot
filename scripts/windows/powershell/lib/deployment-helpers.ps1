function Test-Hash([string]$newLocation, [string]$existingLocation) {
    ...
    $existingSourceArchiveHash = Get-ArchiveHash -File $existingLocation
    $sourceArchiveHash = Get-ArchiveHash -File $newLocation
