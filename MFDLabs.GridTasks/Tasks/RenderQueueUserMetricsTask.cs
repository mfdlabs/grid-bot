...
namespace MFDLabs.Grid.Bot
{
    namespace Tasks
    {
        ...
        public sealed class RenderQueueSlashCommandUserMetricsTask : ExpiringTaskThread<RenderQueueSlashCommandUserMetricsTask, SocketSlashCommand>
        {
        ...
        public sealed class RenderQueueUserMetricsTask : ExpiringTaskThread<RenderQueueUserMetricsTask, SocketTaskRequest>
        {
