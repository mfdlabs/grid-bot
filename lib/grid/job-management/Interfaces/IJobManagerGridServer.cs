...
/// of both Win32 and Linux Grid Servers.
/// </remarks>
public interface IJobManagerGridServer
{
    /// <summary>
    /// Gets the raw job manager.
    /// </summary>
    JobManagerBase JobManager { get; }
    ...
    /// Run a batch job.
    /// </summary>
    /// <param name="gridJob">The SOAP job.</param>
    /// <param name="script">The script.</param>
    /// <returns>The result of the batch job.</returns>
    LuaValue[] RunBatchJob(GridJob gridJob, ScriptExecution script);
    ...
    /// <param name="script">The script.</param>
    /// <returns>The result of the batch job.</returns>
    LuaValue[] RunBatchJob(GridJob gridJob, GridCommand script);
}