...
internal static class SettingsProvidersDefaults
{
    ...
    public const string ArbiterPath = $"{ProviderPathPrefix}/arbiter/{ProviderPathConfiguration}";
    ...
    public const string ExceptionBasedAutomoderatorPath = $"{ProviderPathPrefix}/exception-auto-moderator/{ProviderPathConfiguration}";
