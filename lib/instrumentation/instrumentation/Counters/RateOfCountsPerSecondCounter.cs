...
namespace MFDLabs.Instrumentation
{
    internal class RateOfCountsPerSecondCounter : CounterBase, IRateOfCountsPerSecondCounter
    {
        ...
        public void IncrementBy(long eventCount) => Interlocked.Add(ref _NumberOfEvents, eventCount);
        public void Increment() => IncrementBy(1);
        internal override double Flush()
        {
            var now = DateTime.UtcNow;
            var exchangedNumberOfEvents = Interlocked.Exchange(ref _NumberOfEvents, 0);
