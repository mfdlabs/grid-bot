...
namespace Instrumentation.PrometheusListener
{
    public sealed class PrometheusServerWrapper
    {
        ...
        public void StopMetricsEndpoint() => _MetricServer.Stop();
        public int GetPort() => _CurrentPort;
        public void SetPort(int port) => _CurrentPort = port;
        ...
        private bool PortInUse(int port) => IPGlobalProperties.GetIPGlobalProperties().GetActiveTcpListeners().Any((IPEndPoint endPoint) => endPoint.Port == port);
