    ...
    internal sealed class UpdateAdmins : IStateSpecificCommandHandler
    {
        ...
        public async Task Invoke(string[] messageContentArray, SocketMessage message, string originalCommand)
        {
            ...
            case "add":
                ...
                await message.ReplyAsync($"The user '{user}' is already an admin, if you want to remove them, please re-run this command like: '{Settings.Singleton.Prefix}{originalCommand} remove {user}'.");
                break;
            case "remove":
                if (admins.Contains(user))
                {
                ...
                await message.ReplyAsync($"The user '{user}' is not an admin, if you want to add them, please re-run this command like: '{Settings.Singleton.Prefix}{originalCommand} add {user}'.");
                break;
            default:
